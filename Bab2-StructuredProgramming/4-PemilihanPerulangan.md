...
2. Selagi `i` bernilai kurang dari atau sama dengan 10, maka jalankan perintah `printf("Quack!\n")` kemudian `i++`. Dalam tahap ini, sembari mengulang operasi, nilai dari variabel `i` di-_increment_ (ditambah dengan 1) untuk mencapai nilai 10 sehingga program dapat keluar dari perulangan.
